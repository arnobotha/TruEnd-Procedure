...
# calculating the realised LGD from resolved default spells. TruEnd-procedure not applied.
# ---------------------------------------------------------------------------------------
...
# Also note that by not applying the TruEnd-procedure, we do not have the field 
# [HasTrailingZeroBalances]
# =======================================================================================
