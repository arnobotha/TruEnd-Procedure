...
# precede any (non-clustered) subsampling. TruEnd-procedure not applied.
# ---------------------------------------------------------------------------------------
...
#
# -- Inputs:
#   - datCredit_real | Prepared credit data from script 2d(ii)
#
# -- Outputs:
...
if (!exists('datExclusions')) unpack.ffdf(paste0(genObjPath,"Exclusions-NoTruEnd"), tempPath)
...
pack.ffdf(paste0(genObjPath,"Exclusions-NoTruEnd-Enriched"), datExclusions);
...
pack.ffdf(paste0(genPath, "creditdata_final4-NoTruEnd"), datCredit_real); gc()
